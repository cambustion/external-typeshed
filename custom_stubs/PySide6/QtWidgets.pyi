...
class QMenu(PySide6.QtWidgets.QWidget):
    ...
    def addAction(self, action: PySide6.QtGui.QAction) -> None: ...
    @overload
    def addAction(self, arg__1: Union[PySide6.QtGui.QIcon, PySide6.QtGui.QPixmap], text: str, arg__3: object, shortcut: Union[PySide6.QtGui.QKeySequence, PySide6.QtCore.QKeyCombination, PySide6.QtGui.QKeySequence.StandardKey, str, int, None] = ...) -> None: ...
    @overload
    def addAction(self, icon: Union[PySide6.QtGui.QIcon, PySide6.QtGui.QPixmap], text: str) -> PySide6.QtGui.QAction: ...
    @overload
    def addAction(self, icon: Union[PySide6.QtGui.QIcon, PySide6.QtGui.QPixmap], text: str, callable: object) -> PySide6.QtGui.QAction: ...
    ...
    def addAction(self, text: str) -> PySide6.QtGui.QAction: ...
    @overload
    def addAction(self, text: str, arg__2: object, shortcut: Union[PySide6.QtGui.QKeySequence, PySide6.QtCore.QKeyCombination, PySide6.QtGui.QKeySequence.StandardKey, str, int, None] = ...) -> None: ...
    @overload
    def addAction(self, text: str, callable: object) -> PySide6.QtGui.QAction: ...
    @overload
...
class QMessageBox(PySide6.QtWidgets.QDialog):
    ...
    @overload
    @staticmethod
    def critical(parent: Optional[PySide6.QtWidgets.QWidget], title: str, text: str, button0: PySide6.QtWidgets.QMessageBox.StandardButton, button1: PySide6.QtWidgets.QMessageBox.StandardButton) -> int: ...
    @overload
    @staticmethod
    def critical(parent: Optional[PySide6.QtWidgets.QWidget], title: str, text: str, buttons: PySide6.QtWidgets.QMessageBox.StandardButton = ..., defaultButton: PySide6.QtWidgets.QMessageBox.StandardButton = ...) -> PySide6.QtWidgets.QMessageBox.StandardButton: ...
